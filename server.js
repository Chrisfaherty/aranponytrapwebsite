    ...
    return `
        ...
        <head>
            <style>
                ...
                .btn { background: #d4a574; color: #2c3e50; padding: 12px 24px; text-decoration: none; border-radius: 25px; display: inline-block; font-weight: bold; margin: 10px 0; }
            </style>
        </head>
        <body>
            <div class="container">
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <p><strong>Quick Reply Template:</strong><br>
                    Subject: Booking Confirmation - Aran Pony Trap Tours [${new Date(formData['preferred-date']).toLocaleDateString('en-IE')}]</p>
                </div>
            </div>
        </body>
        </html>
...
app.post('/api/test-email', async (req, res) => {
    try {
        ...
        const testEmailOptions = {
            ...
            subject: 'Test Email - Aran Pony Trap Website',
            html: `
...
app.listen(PORT, () => {
    ...
    console.log(`💼 Business email: ${process.env.BUSINESS_EMAIL || process.env.EMAIL_USER}`);
});